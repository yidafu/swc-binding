...
const InputPath = [
    ...
    '../../swc-binding/src/main/kotlin/dev/yidafu/swc/types/types.kt',
    '../../swc-binding/src/main/kotlin/dev/yidafu/swc/types/serializer.kt',
    '../../swc-binding/src/main/kotlin/dev/yidafu/swc/dsl/',
    "./test.ts",
    './ouptput.kt',
    './serializer.kt',
    './dsl',

...
fun main() {
    ...
    if (generateResult.isSuccess()) {
        ...
        if (loadResult.isSuccess()) {
            ...
            if (validationResult.isSuccess()) {
                ...
                println("✗ 配置验证失败: ${validationResult.getOrNull()?.message}")
            }
            
        } else {
            println("✗ 配置文件解析失败: ${loadResult.getOrNull()?.message}")
        }
        ...
        println("✗ 示例配置文件生成失败: ${generateResult.getOrNull()?.message}")
    }
    ...
    if (defaultResult.isSuccess()) {
        ...
        println("✗ 默认配置加载失败: ${defaultResult.getOrNull()?.message}")
    }

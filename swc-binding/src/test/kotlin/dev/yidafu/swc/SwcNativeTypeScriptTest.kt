...
/**
 * Comprehensive tests for TypeScript parsing and transformation
 * Merged from SwcNativeTypeScriptTest and TypeScriptSyntaxTest
 */
class SwcNativeTypeScriptTest : AnnotationSpec() {
    ...
    @Test
    fun `template literal with TypeScript type`() {
        val output = swcNative.parseSync(

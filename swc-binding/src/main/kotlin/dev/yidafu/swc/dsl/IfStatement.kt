...
/**
 * IfStatement#type: String
 * extension function for create String -> String
 */
public fun IfStatement.string(block: String.() -> Unit): String = String().apply(block)

/**
 * IfStatement#test: Expression
 * extension function for create Expression -> ThisExpressionImpl
 */
public fun IfStatement.thisExpression(block: ThisExpression.() -> Unit): ThisExpression =
 ...
 */
public fun IfStatement.arrayExpression(block: ArrayExpression.() -> Unit): ArrayExpression =
 ...
 */
public fun IfStatement.objectExpression(block: ObjectExpression.() -> Unit): ObjectExpression =
 ...
 */
public fun IfStatement.functionExpression(block: FunctionExpression.() -> Unit): FunctionExpression
 ...
 */
public fun IfStatement.unaryExpression(block: UnaryExpression.() -> Unit): UnaryExpression =
 ...
 */
public fun IfStatement.updateExpression(block: UpdateExpression.() -> Unit): UpdateExpression =
 ...
 */
public fun IfStatement.binaryExpression(block: BinaryExpression.() -> Unit): BinaryExpression =
 ...
 */
public fun IfStatement.assignmentExpression(block: AssignmentExpression.() -> Unit):
 ...
 */
public fun IfStatement.memberExpression(block: MemberExpression.() -> Unit): MemberExpression =
 ...
 */
public fun IfStatement.superPropExpression(block: SuperPropExpression.() -> Unit):
 ...
 */
public fun IfStatement.conditionalExpression(block: ConditionalExpression.() -> Unit):
 ...
 */
public fun IfStatement.callExpression(block: CallExpression.() -> Unit): CallExpression =
 ...
 */
public fun IfStatement.newExpression(block: NewExpression.() -> Unit): NewExpression =
 ...
 */
public fun IfStatement.sequenceExpression(block: SequenceExpression.() -> Unit): SequenceExpression
 ...
 */
public fun IfStatement.stringLiteral(block: StringLiteral.() -> Unit): StringLiteral =
 ...
 */
public fun IfStatement.booleanLiteral(block: BooleanLiteral.() -> Unit): BooleanLiteral =
 ...
 */
public fun IfStatement.nullLiteral(block: NullLiteral.() -> Unit): NullLiteral =
 ...
 */
public fun IfStatement.numericLiteral(block: NumericLiteral.() -> Unit): NumericLiteral =
 ...
 */
public fun IfStatement.bigIntLiteral(block: BigIntLiteral.() -> Unit): BigIntLiteral =
 ...
 */
public fun IfStatement.regExpLiteral(block: RegExpLiteral.() -> Unit): RegExpLiteral =
 ...
 */
public fun IfStatement.jSXText(block: JSXText.() -> Unit): JSXText = JSXTextImpl().apply(block)
 ...
 */
public fun IfStatement.taggedTemplateExpression(block: TaggedTemplateExpression.() -> Unit):
 ...
 */
public fun IfStatement.arrowFunctionExpression(block: ArrowFunctionExpression.() -> Unit):
 ...
 */
public fun IfStatement.classExpression(block: ClassExpression.() -> Unit): ClassExpression =
 ...
 */
public fun IfStatement.yieldExpression(block: YieldExpression.() -> Unit): YieldExpression =
 ...
 */
public fun IfStatement.metaProperty(block: MetaProperty.() -> Unit): MetaProperty =
 ...
 */
public fun IfStatement.parenthesisExpression(block: ParenthesisExpression.() -> Unit):
 ...
 */
public fun IfStatement.jSXMemberExpression(block: JSXMemberExpression.() -> Unit):
 ...
 */
public fun IfStatement.jSXNamespacedName(block: JSXNamespacedName.() -> Unit): JSXNamespacedName =
 ...
 */
public fun IfStatement.jSXEmptyExpression(block: JSXEmptyExpression.() -> Unit): JSXEmptyExpression
 ...
 */
public fun IfStatement.jSXElement(block: JSXElement.() -> Unit): JSXElement =
 ...
 */
public fun IfStatement.jSXFragment(block: JSXFragment.() -> Unit): JSXFragment =
 ...
 */
public fun IfStatement.tsTypeAssertion(block: TsTypeAssertion.() -> Unit): TsTypeAssertion =
 ...
 */
public fun IfStatement.tsConstAssertion(block: TsConstAssertion.() -> Unit): TsConstAssertion =
 ...
 */
public fun IfStatement.tsNonNullExpression(block: TsNonNullExpression.() -> Unit):
 ...
 */
public fun IfStatement.tsAsExpression(block: TsAsExpression.() -> Unit): TsAsExpression =
 ...
 */
public fun IfStatement.tsSatisfiesExpression(block: TsSatisfiesExpression.() -> Unit):
 ...
 */
public fun IfStatement.tsInstantiation(block: TsInstantiation.() -> Unit): TsInstantiation =
 ...
 */
public fun IfStatement.privateName(block: PrivateName.() -> Unit): PrivateName =
 ...
 */
public fun IfStatement.optionalChainingExpression(block: OptionalChainingExpression.() -> Unit):
 ...
 */
public fun IfStatement.invalid(block: Invalid.() -> Unit): Invalid = InvalidImpl().apply(block)
 ...
 */
public fun IfStatement.emptyStatement(block: EmptyStatement.() -> Unit): EmptyStatement =
 ...
 */
public fun IfStatement.debuggerStatement(block: DebuggerStatement.() -> Unit): DebuggerStatement =
 ...
 */
public fun IfStatement.withStatement(block: WithStatement.() -> Unit): WithStatement =
 ...
 */
public fun IfStatement.returnStatement(block: ReturnStatement.() -> Unit): ReturnStatement =
 ...
 */
public fun IfStatement.labeledStatement(block: LabeledStatement.() -> Unit): LabeledStatement =
 ...
 */
public fun IfStatement.breakStatement(block: BreakStatement.() -> Unit): BreakStatement =
 ...
 */
public fun IfStatement.continueStatement(block: ContinueStatement.() -> Unit): ContinueStatement =
 ...
 */
public fun IfStatement.switchStatement(block: SwitchStatement.() -> Unit): SwitchStatement =
 ...
 */
public fun IfStatement.throwStatement(block: ThrowStatement.() -> Unit): ThrowStatement =
 ...
 */
public fun IfStatement.tryStatement(block: TryStatement.() -> Unit): TryStatement =
 ...
 */
public fun IfStatement.whileStatement(block: WhileStatement.() -> Unit): WhileStatement =
 ...
 */
public fun IfStatement.doWhileStatement(block: DoWhileStatement.() -> Unit): DoWhileStatement =
 ...
 */
public fun IfStatement.forStatement(block: ForStatement.() -> Unit): ForStatement =
 ...
 */
public fun IfStatement.forInStatement(block: ForInStatement.() -> Unit): ForInStatement =
 ...
 */
public fun IfStatement.forOfStatement(block: ForOfStatement.() -> Unit): ForOfStatement =
 ...
 */
public fun IfStatement.classDeclaration(block: ClassDeclaration.() -> Unit): ClassDeclaration =
 ...
 */
public fun IfStatement.functionDeclaration(block: FunctionDeclaration.() -> Unit):
 ...
 */
public fun IfStatement.variableDeclaration(block: VariableDeclaration.() -> Unit):
 ...
 */
public fun IfStatement.tsInterfaceDeclaration(block: TsInterfaceDeclaration.() -> Unit):
 ...
 */
public fun IfStatement.tsTypeAliasDeclaration(block: TsTypeAliasDeclaration.() -> Unit):
 ...
 */
public fun IfStatement.tsEnumDeclaration(block: TsEnumDeclaration.() -> Unit): TsEnumDeclaration =
 ...
 */
public fun IfStatement.expressionStatement(block: ExpressionStatement.() -> Unit):
 ...
 */
public fun IfStatement.span(block: Span.() -> Unit): Span = SpanImpl().apply(block)

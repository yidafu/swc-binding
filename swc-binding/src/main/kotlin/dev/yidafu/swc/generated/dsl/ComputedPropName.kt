// Auto-generated file. Do not edit. Generated at: 2025-11-20T00:09:39.255928
 ...
 */
public fun ComputedPropName.invalid(block: Invalid.() -> Unit): Invalid = Invalid().apply(block)

/**
 * ComputedPropName#expression: Expression?
 * extension function for create Expression? -> JSXText
 */
public fun ComputedPropName.jSXText(block: JSXText.() -> Unit): JSXText = JSXText().apply(block)

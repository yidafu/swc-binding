// Auto-generated file. Do not edit. Generated at: 2025-11-20T00:09:39.288336
 ...
 */
public fun SwitchStatement.invalid(block: Invalid.() -> Unit): Invalid = Invalid().apply(block)

/**
 * SwitchStatement#discriminant: Expression?
 * extension function for create Expression? -> JSXText
 */
public fun SwitchStatement.jSXText(block: JSXText.() -> Unit): JSXText = JSXText().apply(block)
 ...
 * extension function for create Array<SwitchCase>? -> SwitchCase
 */

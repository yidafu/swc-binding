...
import dev.yidafu.swc.generated.ClassPropertyBase
 ...
 */
public fun ClassPropertyBase.invalid(block: Invalid.() -> Unit): Invalid = Invalid().apply(block)

/**
 * ClassPropertyBase#value: Expression?
 * extension function for create Expression? -> JSXText
 */
public fun ClassPropertyBase.jSXText(block: JSXText.() -> Unit): JSXText = JSXText().apply(block)

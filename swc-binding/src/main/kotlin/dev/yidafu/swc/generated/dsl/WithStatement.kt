 ...
 */
public fun WithStatement.invalid(block: Invalid.() -> Unit): Invalid = Invalid().apply(block)

/**
 * WithStatement#`object`: Expression?
 * extension function for create Expression? -> JSXText
 */
public fun WithStatement.jSXText(block: JSXText.() -> Unit): JSXText = JSXText().apply(block)

 ...
 */
public fun AssignmentExpression.`constructor`(block: Constructor.() -> Unit): Constructor =
 ...
 */
public fun AssignmentExpression.staticBlock(block: StaticBlock.() -> Unit): StaticBlock =
 ...
 */
public fun AssignmentExpression.decorator(block: Decorator.() -> Unit): Decorator =
 ...
 */
public fun AssignmentExpression.classDeclaration(block: ClassDeclaration.() -> Unit):
 ...
 */
public fun AssignmentExpression.spreadElement(block: SpreadElement.() -> Unit): SpreadElement =
 ...
 */
public fun AssignmentExpression.jsSuper(block: JsSuper.() -> Unit): JsSuper = JsSuper().apply(block)

/**
 * AssignmentExpression#left: Node?
 * extension function for create Node? -> JsImport
 */
public fun AssignmentExpression.jsImport(block: JsImport.() -> Unit): JsImport =
 ...
 */
public fun AssignmentExpression.jSXExpressionContainer(block: JSXExpressionContainer.() -> Unit):
 ...
 */
public fun AssignmentExpression.jSXAttribute(block: JSXAttribute.() -> Unit): JSXAttribute =
 ...
 */
public fun AssignmentExpression.jSXText(block: JSXText.() -> Unit): JSXText = JSXText().apply(block)
 ...
 */
public fun AssignmentExpression.jSXOpeningFragment(block: JSXOpeningFragment.() -> Unit):
 ...
 */
public fun AssignmentExpression.jSXClosingFragment(block: JSXClosingFragment.() -> Unit):
 ...
 */
public fun AssignmentExpression.exportDefaultExpression(block: ExportDefaultExpression.() -> Unit):
 ...
 */
public fun AssignmentExpression.exportDeclaration(block: ExportDeclaration.() -> Unit):
 ...
 */
public fun AssignmentExpression.importDeclaration(block: ImportDeclaration.() -> Unit):
 ...
 */
public fun AssignmentExpression.exportAllDeclaration(block: ExportAllDeclaration.() -> Unit):
 ...
 */
public fun AssignmentExpression.exportNamedDeclaration(block: ExportNamedDeclaration.() -> Unit):
 ...
 */
public
    fun AssignmentExpression.exportDefaultDeclaration(block: ExportDefaultDeclaration.() -> Unit):
 ...
 */
public fun AssignmentExpression.importDefaultSpecifier(block: ImportDefaultSpecifier.() -> Unit):
 ...
 */
public
    fun AssignmentExpression.importNamespaceSpecifier(block: ImportNamespaceSpecifier.() -> Unit):
 ...
 */
public fun AssignmentExpression.namedImportSpecifier(block: NamedImportSpecifier.() -> Unit):
 ...
 */
public
    fun AssignmentExpression.exportNamespaceSpecifier(block: ExportNamespaceSpecifier.() -> Unit):
 ...
 */
public fun AssignmentExpression.exportDefaultSpecifier(block: ExportDefaultSpecifier.() -> Unit):
 ...
 */
public fun AssignmentExpression.namedExportSpecifier(block: NamedExportSpecifier.() -> Unit):
 ...
 */
public fun AssignmentExpression.module(block: Module.() -> Unit): Module = Module().apply(block)

/**
 * AssignmentExpression#left: Node?
 * extension function for create Node? -> Script
 */
public fun AssignmentExpression.script(block: Script.() -> Unit): Script = Script().apply(block)

/**
 * AssignmentExpression#left: Node?
 * extension function for create Node? -> KeyValuePatternProperty
 */
public fun AssignmentExpression.keyValuePatternProperty(block: KeyValuePatternProperty.() -> Unit):
 ...
 */
public
    fun AssignmentExpression.assignmentPatternProperty(block: AssignmentPatternProperty.() -> Unit):
 ...
 */
public fun AssignmentExpression.assignmentProperty(block: AssignmentProperty.() -> Unit):
 ...
 */
public fun AssignmentExpression.expressionStatement(block: ExpressionStatement.() -> Unit):
 ...
 */
public fun AssignmentExpression.emptyStatement(block: EmptyStatement.() -> Unit): EmptyStatement =
 ...
 */
public fun AssignmentExpression.debuggerStatement(block: DebuggerStatement.() -> Unit):
 ...
 */
public fun AssignmentExpression.withStatement(block: WithStatement.() -> Unit): WithStatement =
 ...
 */
public fun AssignmentExpression.returnStatement(block: ReturnStatement.() -> Unit): ReturnStatement
 ...
 */
public fun AssignmentExpression.labeledStatement(block: LabeledStatement.() -> Unit):
 ...
 */
public fun AssignmentExpression.breakStatement(block: BreakStatement.() -> Unit): BreakStatement =
 ...
 */
public fun AssignmentExpression.continueStatement(block: ContinueStatement.() -> Unit):
 ...
 */
public fun AssignmentExpression.ifStatement(block: IfStatement.() -> Unit): IfStatement =
 ...
 */
public fun AssignmentExpression.switchStatement(block: SwitchStatement.() -> Unit): SwitchStatement
 ...
 */
public fun AssignmentExpression.throwStatement(block: ThrowStatement.() -> Unit): ThrowStatement =
 ...
 */
public fun AssignmentExpression.tryStatement(block: TryStatement.() -> Unit): TryStatement =
 ...
 */
public fun AssignmentExpression.whileStatement(block: WhileStatement.() -> Unit): WhileStatement =
 ...
 */
public fun AssignmentExpression.doWhileStatement(block: DoWhileStatement.() -> Unit):
 ...
 */
public fun AssignmentExpression.forStatement(block: ForStatement.() -> Unit): ForStatement =
 ...
 */
public fun AssignmentExpression.forInStatement(block: ForInStatement.() -> Unit): ForInStatement =
 ...
 */
public fun AssignmentExpression.forOfStatement(block: ForOfStatement.() -> Unit): ForOfStatement =
 ...
 */
public fun AssignmentExpression.switchCase(block: SwitchCase.() -> Unit): SwitchCase =
 ...
 */
public fun AssignmentExpression.catchClause(block: CatchClause.() -> Unit): CatchClause =
 ...
 */
public fun AssignmentExpression.tsTypeAnnotation(block: TsTypeAnnotation.() -> Unit):
 ...
 */
public
    fun AssignmentExpression.tsTypeParameterDeclaration(block: TsTypeParameterDeclaration.() -> Unit):
 ...
 */
public fun AssignmentExpression.tsTypeParameter(block: TsTypeParameter.() -> Unit): TsTypeParameter
 ...
 */
public
    fun AssignmentExpression.tsTypeParameterInstantiation(block: TsTypeParameterInstantiation.() -> Unit):
 ...
 */
public fun AssignmentExpression.tsParameterProperty(block: TsParameterProperty.() -> Unit):
 ...
 */
public fun AssignmentExpression.tsQualifiedName(block: TsQualifiedName.() -> Unit): TsQualifiedName
 ...
 */
public
    fun AssignmentExpression.tsCallSignatureDeclaration(block: TsCallSignatureDeclaration.() -> Unit):
 ...
 */
public
    fun AssignmentExpression.tsConstructSignatureDeclaration(block: TsConstructSignatureDeclaration.() -> Unit):
 ...
 */
public fun AssignmentExpression.tsPropertySignature(block: TsPropertySignature.() -> Unit):
 ...
 */
public fun AssignmentExpression.tsGetterSignature(block: TsGetterSignature.() -> Unit):
 ...
 */
public fun AssignmentExpression.tsSetterSignature(block: TsSetterSignature.() -> Unit):
 ...
 */
public fun AssignmentExpression.tsMethodSignature(block: TsMethodSignature.() -> Unit):
 ...
 */
public fun AssignmentExpression.tsIndexSignature(block: TsIndexSignature.() -> Unit):
 ...
 */
public fun AssignmentExpression.tsKeywordType(block: TsKeywordType.() -> Unit): TsKeywordType =
 ...
 */
public fun AssignmentExpression.tsThisType(block: TsThisType.() -> Unit): TsThisType =
 ...
 */
public fun AssignmentExpression.tsFunctionType(block: TsFunctionType.() -> Unit): TsFunctionType =
 ...
 */
public fun AssignmentExpression.tsConstructorType(block: TsConstructorType.() -> Unit):
 ...
 */
public fun AssignmentExpression.tsTypeReference(block: TsTypeReference.() -> Unit): TsTypeReference
 ...
 */
public fun AssignmentExpression.tsTypePredicate(block: TsTypePredicate.() -> Unit): TsTypePredicate
 ...
 */
public fun AssignmentExpression.tsImportType(block: TsImportType.() -> Unit): TsImportType =
 ...
 */
public fun AssignmentExpression.tsTypeQuery(block: TsTypeQuery.() -> Unit): TsTypeQuery =
 ...
 */
public fun AssignmentExpression.tsTypeLiteral(block: TsTypeLiteral.() -> Unit): TsTypeLiteral =
 ...
 */
public fun AssignmentExpression.tsArrayType(block: TsArrayType.() -> Unit): TsArrayType =
 ...
 */
public fun AssignmentExpression.tsTupleType(block: TsTupleType.() -> Unit): TsTupleType =
 ...
 */
public fun AssignmentExpression.tsTupleElement(block: TsTupleElement.() -> Unit): TsTupleElement =
 ...
 */
public fun AssignmentExpression.tsOptionalType(block: TsOptionalType.() -> Unit): TsOptionalType =
 ...
 */
public fun AssignmentExpression.tsRestType(block: TsRestType.() -> Unit): TsRestType =
 ...
 */
public fun AssignmentExpression.tsUnionType(block: TsUnionType.() -> Unit): TsUnionType =
 ...
 */
public fun AssignmentExpression.tsIntersectionType(block: TsIntersectionType.() -> Unit):
 ...
 */
public fun AssignmentExpression.tsConditionalType(block: TsConditionalType.() -> Unit):
 ...
 */
public fun AssignmentExpression.tsInferType(block: TsInferType.() -> Unit): TsInferType =
 ...
 */
public fun AssignmentExpression.tsParenthesizedType(block: TsParenthesizedType.() -> Unit):
 ...
 */
public fun AssignmentExpression.tsTypeOperator(block: TsTypeOperator.() -> Unit): TsTypeOperator =
 ...
 */
public fun AssignmentExpression.tsIndexedAccessType(block: TsIndexedAccessType.() -> Unit):
 ...
 */
public fun AssignmentExpression.tsMappedType(block: TsMappedType.() -> Unit): TsMappedType =
 ...
 */
public fun AssignmentExpression.tsLiteralType(block: TsLiteralType.() -> Unit): TsLiteralType =
 ...
 */
public fun AssignmentExpression.tsInterfaceBody(block: TsInterfaceBody.() -> Unit): TsInterfaceBody
 ...
 */
public
    fun AssignmentExpression.tsExpressionWithTypeArguments(block: TsExpressionWithTypeArguments.() -> Unit):
 ...
 */
public fun AssignmentExpression.tsTypeAliasDeclaration(block: TsTypeAliasDeclaration.() -> Unit):
 ...
 */
public fun AssignmentExpression.tsEnumDeclaration(block: TsEnumDeclaration.() -> Unit):
 ...
 */
public fun AssignmentExpression.tsEnumMember(block: TsEnumMember.() -> Unit): TsEnumMember =
 ...
 */
public fun AssignmentExpression.tsModuleDeclaration(block: TsModuleDeclaration.() -> Unit):
 ...
 */
public fun AssignmentExpression.tsModuleBlock(block: TsModuleBlock.() -> Unit): TsModuleBlock =
 ...
 */
public fun AssignmentExpression.tsNamespaceDeclaration(block: TsNamespaceDeclaration.() -> Unit):
 ...
 */
public
    fun AssignmentExpression.tsImportEqualsDeclaration(block: TsImportEqualsDeclaration.() -> Unit):
 ...
 */
public
    fun AssignmentExpression.tsExternalModuleReference(block: TsExternalModuleReference.() -> Unit):
 ...
 */
public fun AssignmentExpression.tsExportAssignment(block: TsExportAssignment.() -> Unit):
 ...
 */
public
    fun AssignmentExpression.tsNamespaceExportDeclaration(block: TsNamespaceExportDeclaration.() -> Unit):
 ...
 */
public fun AssignmentExpression.invalid(block: Invalid.() -> Unit): Invalid = Invalid().apply(block)

/**
 * AssignmentExpression#left: Node?
 * extension function for create Node? -> ClassProperty
 */
public fun AssignmentExpression.classProperty(block: ClassProperty.() -> Unit): ClassProperty =
 ...
 */
public fun AssignmentExpression.privateProperty(block: PrivateProperty.() -> Unit): PrivateProperty
 ...
 */
public fun AssignmentExpression.classMethod(block: ClassMethod.() -> Unit): ClassMethod =
 ...
 */
public fun AssignmentExpression.privateMethod(block: PrivateMethod.() -> Unit): PrivateMethod =
 ...
 */
public fun AssignmentExpression.templateElement(block: TemplateElement.() -> Unit): TemplateElement
 ...
 */
public fun AssignmentExpression.keyValueProperty(block: KeyValueProperty.() -> Unit):
 ...
 */
public fun AssignmentExpression.getterProperty(block: GetterProperty.() -> Unit): GetterProperty =
 ...
 */
public fun AssignmentExpression.setterProperty(block: SetterProperty.() -> Unit): SetterProperty =

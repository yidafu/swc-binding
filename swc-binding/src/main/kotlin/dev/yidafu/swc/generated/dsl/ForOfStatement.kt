// Auto-generated file. Do not edit. Generated at: 2025-11-20T00:09:39.401075
...
/**
 * ForOfStatement#left: Node?
 * extension function for create Node? -> Constructor
 */
public fun ForOfStatement.`constructor`(block: Constructor.() -> Unit): Constructor =
 ...
 */
public fun ForOfStatement.staticBlock(block: StaticBlock.() -> Unit): StaticBlock =
 ...
 */
public fun ForOfStatement.decorator(block: Decorator.() -> Unit): Decorator =
 ...
 */
public fun ForOfStatement.spreadElement(block: SpreadElement.() -> Unit): SpreadElement =
 ...
 */
public fun ForOfStatement.jsSuper(block: JsSuper.() -> Unit): JsSuper = JsSuper().apply(block)

/**
 * ForOfStatement#left: Node?
 * extension function for create Node? -> JsImport
 */
public fun ForOfStatement.jsImport(block: JsImport.() -> Unit): JsImport = JsImport().apply(block)
 ...
 */
public fun ForOfStatement.jSXExpressionContainer(block: JSXExpressionContainer.() -> Unit):
 ...
 */
public fun ForOfStatement.jSXSpreadChild(block: JSXSpreadChild.() -> Unit): JSXSpreadChild =
 ...
 */
public fun ForOfStatement.jSXAttribute(block: JSXAttribute.() -> Unit): JSXAttribute =
 ...
 */
public fun ForOfStatement.jSXText(block: JSXText.() -> Unit): JSXText = JSXText().apply(block)
 ...
 */
public fun ForOfStatement.jSXOpeningFragment(block: JSXOpeningFragment.() -> Unit):
 ...
 */
public fun ForOfStatement.jSXClosingFragment(block: JSXClosingFragment.() -> Unit):
 ...
 */
public fun ForOfStatement.exportDefaultExpression(block: ExportDefaultExpression.() -> Unit):
 ...
 */
public fun ForOfStatement.exportDeclaration(block: ExportDeclaration.() -> Unit): ExportDeclaration
 ...
 */
public fun ForOfStatement.importDeclaration(block: ImportDeclaration.() -> Unit): ImportDeclaration
 ...
 */
public fun ForOfStatement.exportAllDeclaration(block: ExportAllDeclaration.() -> Unit):
 ...
 */
public fun ForOfStatement.exportNamedDeclaration(block: ExportNamedDeclaration.() -> Unit):
 ...
 */
public fun ForOfStatement.exportDefaultDeclaration(block: ExportDefaultDeclaration.() -> Unit):
 ...
 */
public fun ForOfStatement.importDefaultSpecifier(block: ImportDefaultSpecifier.() -> Unit):
 ...
 */
public fun ForOfStatement.importNamespaceSpecifier(block: ImportNamespaceSpecifier.() -> Unit):
 ...
 */
public fun ForOfStatement.namedImportSpecifier(block: NamedImportSpecifier.() -> Unit):
 ...
 */
public fun ForOfStatement.exportNamespaceSpecifier(block: ExportNamespaceSpecifier.() -> Unit):
 ...
 */
public fun ForOfStatement.exportDefaultSpecifier(block: ExportDefaultSpecifier.() -> Unit):
 ...
 */
public fun ForOfStatement.namedExportSpecifier(block: NamedExportSpecifier.() -> Unit):
 ...
 */
public fun ForOfStatement.module(block: Module.() -> Unit): Module = Module().apply(block)

/**
 * ForOfStatement#left: Node?
 * extension function for create Node? -> Script
 */
public fun ForOfStatement.script(block: Script.() -> Unit): Script = Script().apply(block)

/**
 * ForOfStatement#left: Node?
 * extension function for create Node? -> KeyValuePatternProperty
 */
public fun ForOfStatement.keyValuePatternProperty(block: KeyValuePatternProperty.() -> Unit):
 ...
 */
public fun ForOfStatement.assignmentPatternProperty(block: AssignmentPatternProperty.() -> Unit):
 ...
 */
public fun ForOfStatement.assignmentProperty(block: AssignmentProperty.() -> Unit):
 ...
 */
public fun ForOfStatement.computedPropName(block: ComputedPropName.() -> Unit): ComputedPropName =
 ...
 */
public fun ForOfStatement.switchCase(block: SwitchCase.() -> Unit): SwitchCase =
 ...
 */
public fun ForOfStatement.catchClause(block: CatchClause.() -> Unit): CatchClause =
 ...
 */
public fun ForOfStatement.tsTypeAnnotation(block: TsTypeAnnotation.() -> Unit): TsTypeAnnotation =
 ...
 */
public fun ForOfStatement.tsTypeParameterDeclaration(block: TsTypeParameterDeclaration.() -> Unit):
 ...
 */
public fun ForOfStatement.tsTypeParameter(block: TsTypeParameter.() -> Unit): TsTypeParameter =
 ...
 */
public
    fun ForOfStatement.tsTypeParameterInstantiation(block: TsTypeParameterInstantiation.() -> Unit):
 ...
 */
public fun ForOfStatement.tsParameterProperty(block: TsParameterProperty.() -> Unit):
 ...
 */
public fun ForOfStatement.tsQualifiedName(block: TsQualifiedName.() -> Unit): TsQualifiedName =
 ...
 */
public fun ForOfStatement.tsCallSignatureDeclaration(block: TsCallSignatureDeclaration.() -> Unit):
 ...
 */
public
    fun ForOfStatement.tsConstructSignatureDeclaration(block: TsConstructSignatureDeclaration.() -> Unit):
 ...
 */
public fun ForOfStatement.tsPropertySignature(block: TsPropertySignature.() -> Unit):
 ...
 */
public fun ForOfStatement.tsGetterSignature(block: TsGetterSignature.() -> Unit): TsGetterSignature
 ...
 */
public fun ForOfStatement.tsSetterSignature(block: TsSetterSignature.() -> Unit): TsSetterSignature
 ...
 */
public fun ForOfStatement.tsMethodSignature(block: TsMethodSignature.() -> Unit): TsMethodSignature
 ...
 */
public fun ForOfStatement.tsIndexSignature(block: TsIndexSignature.() -> Unit): TsIndexSignature =
 ...
 */
public fun ForOfStatement.tsKeywordType(block: TsKeywordType.() -> Unit): TsKeywordType =
 ...
 */
public fun ForOfStatement.tsThisType(block: TsThisType.() -> Unit): TsThisType =
 ...
 */
public fun ForOfStatement.tsFunctionType(block: TsFunctionType.() -> Unit): TsFunctionType =
 ...
 */
public fun ForOfStatement.tsConstructorType(block: TsConstructorType.() -> Unit): TsConstructorType
 ...
 */
public fun ForOfStatement.tsTypeReference(block: TsTypeReference.() -> Unit): TsTypeReference =
 ...
 */
public fun ForOfStatement.tsTypePredicate(block: TsTypePredicate.() -> Unit): TsTypePredicate =
 ...
 */
public fun ForOfStatement.tsImportType(block: TsImportType.() -> Unit): TsImportType =
 ...
 */
public fun ForOfStatement.tsTypeQuery(block: TsTypeQuery.() -> Unit): TsTypeQuery =
 ...
 */
public fun ForOfStatement.tsTypeLiteral(block: TsTypeLiteral.() -> Unit): TsTypeLiteral =
 ...
 */
public fun ForOfStatement.tsArrayType(block: TsArrayType.() -> Unit): TsArrayType =
 ...
 */
public fun ForOfStatement.tsTupleType(block: TsTupleType.() -> Unit): TsTupleType =
 ...
 */
public fun ForOfStatement.tsTupleElement(block: TsTupleElement.() -> Unit): TsTupleElement =
 ...
 */
public fun ForOfStatement.tsOptionalType(block: TsOptionalType.() -> Unit): TsOptionalType =
 ...
 */
public fun ForOfStatement.tsRestType(block: TsRestType.() -> Unit): TsRestType =
 ...
 */
public fun ForOfStatement.tsUnionType(block: TsUnionType.() -> Unit): TsUnionType =
 ...
 */
public fun ForOfStatement.tsIntersectionType(block: TsIntersectionType.() -> Unit):
 ...
 */
public fun ForOfStatement.tsConditionalType(block: TsConditionalType.() -> Unit): TsConditionalType
 ...
 */
public fun ForOfStatement.tsInferType(block: TsInferType.() -> Unit): TsInferType =
 ...
 */
public fun ForOfStatement.tsParenthesizedType(block: TsParenthesizedType.() -> Unit):
 ...
 */
public fun ForOfStatement.tsTypeOperator(block: TsTypeOperator.() -> Unit): TsTypeOperator =
 ...
 */
public fun ForOfStatement.tsIndexedAccessType(block: TsIndexedAccessType.() -> Unit):
 ...
 */
public fun ForOfStatement.tsMappedType(block: TsMappedType.() -> Unit): TsMappedType =
 ...
 */
public fun ForOfStatement.tsLiteralType(block: TsLiteralType.() -> Unit): TsLiteralType =
 ...
 */
public fun ForOfStatement.tsInterfaceBody(block: TsInterfaceBody.() -> Unit): TsInterfaceBody =
 ...
 */
public
    fun ForOfStatement.tsExpressionWithTypeArguments(block: TsExpressionWithTypeArguments.() -> Unit):
 ...
 */
public fun ForOfStatement.tsEnumMember(block: TsEnumMember.() -> Unit): TsEnumMember =
 ...
 */
public fun ForOfStatement.tsModuleBlock(block: TsModuleBlock.() -> Unit): TsModuleBlock =
 ...
 */
public fun ForOfStatement.tsNamespaceDeclaration(block: TsNamespaceDeclaration.() -> Unit):
 ...
 */
public fun ForOfStatement.tsImportEqualsDeclaration(block: TsImportEqualsDeclaration.() -> Unit):
 ...
 */
public fun ForOfStatement.tsExternalModuleReference(block: TsExternalModuleReference.() -> Unit):
 ...
 */
public fun ForOfStatement.tsExportAssignment(block: TsExportAssignment.() -> Unit):
 ...
 */
public
    fun ForOfStatement.tsNamespaceExportDeclaration(block: TsNamespaceExportDeclaration.() -> Unit):
 ...
 */
public fun ForOfStatement.invalid(block: Invalid.() -> Unit): Invalid = Invalid().apply(block)

/**
 * ForOfStatement#left: Node?
 * extension function for create Node? -> ClassProperty
 */
public fun ForOfStatement.classProperty(block: ClassProperty.() -> Unit): ClassProperty =
 ...
 */
public fun ForOfStatement.privateProperty(block: PrivateProperty.() -> Unit): PrivateProperty =
 ...
 */
public fun ForOfStatement.classMethod(block: ClassMethod.() -> Unit): ClassMethod =
 ...
 */
public fun ForOfStatement.privateMethod(block: PrivateMethod.() -> Unit): PrivateMethod =
 ...
 */
public fun ForOfStatement.templateElement(block: TemplateElement.() -> Unit): TemplateElement =
 ...
 */
public fun ForOfStatement.keyValueProperty(block: KeyValueProperty.() -> Unit): KeyValueProperty =
 ...
 */
public fun ForOfStatement.getterProperty(block: GetterProperty.() -> Unit): GetterProperty =
 ...
 */
public fun ForOfStatement.setterProperty(block: SetterProperty.() -> Unit): SetterProperty =
 ...
 */
public fun ForOfStatement.methodProperty(block: MethodProperty.() -> Unit): MethodProperty =
 ...
 */
public fun ForOfStatement.`param`(block: Param.() -> Unit): Param = ParamImpl().apply(block)

/**
 * ForOfStatement#left: Node?
 * extension function for create Node? -> VariableDeclarator
 */
public fun ForOfStatement.variableDeclarator(block: VariableDeclarator.() -> Unit):
 ...
 */
public fun ForOfStatement.jSXOpeningElement(block: JSXOpeningElement.() -> Unit): JSXOpeningElement
 ...
 */
public fun ForOfStatement.jSXClosingElement(block: JSXClosingElement.() -> Unit): JSXClosingElement
 ...
 */
public fun ForOfStatement.tsTemplateLiteralType(block: TsTemplateLiteralType.() -> Unit):

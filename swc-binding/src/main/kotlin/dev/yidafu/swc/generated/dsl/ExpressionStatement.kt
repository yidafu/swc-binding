// Auto-generated file. Do not edit. Generated at: 2025-11-20T00:09:39.266289
 ...
 */
public fun ExpressionStatement.invalid(block: Invalid.() -> Unit): Invalid = Invalid().apply(block)

/**
 * ExpressionStatement#expression: Expression?
 * extension function for create Expression? -> JSXText
 */
public fun ExpressionStatement.jSXText(block: JSXText.() -> Unit): JSXText = JSXText().apply(block)

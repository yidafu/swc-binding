...
/**
 * RestElement#rest: Span?
 * extension function for create Span? -> Span
 */
public fun RestElement.span(block: Span.() -> Unit): Span = Span().apply(block)
 ...
 */
public fun RestElement.jSXText(block: JSXText.() -> Unit): JSXText = JSXText().apply(block)

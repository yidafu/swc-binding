 ...
 */
public fun TsNonNullExpression.invalid(block: Invalid.() -> Unit): Invalid = Invalid().apply(block)

/**
 * TsNonNullExpression#expression: Expression?
 * extension function for create Expression? -> JSXText
 */
public fun TsNonNullExpression.jSXText(block: JSXText.() -> Unit): JSXText = JSXText().apply(block)

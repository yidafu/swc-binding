// Auto-generated file. Do not edit. Generated at: 2025-11-20T00:09:39.216488
 ...
 */
public fun CallExpression.`constructor`(block: Constructor.() -> Unit): Constructor =
 ...
 */
public fun CallExpression.staticBlock(block: StaticBlock.() -> Unit): StaticBlock =
 ...
 */
public fun CallExpression.decorator(block: Decorator.() -> Unit): Decorator =
 ...
 */
public fun CallExpression.classDeclaration(block: ClassDeclaration.() -> Unit): ClassDeclaration =
 ...
 */
public fun CallExpression.spreadElement(block: SpreadElement.() -> Unit): SpreadElement =
 ...
 */
public fun CallExpression.jsSuper(block: JsSuper.() -> Unit): JsSuper = JsSuper().apply(block)

/**
 * CallExpression#callee: Node?
 * extension function for create Node? -> JsImport
 */
public fun CallExpression.jsImport(block: JsImport.() -> Unit): JsImport = JsImport().apply(block)
 ...
 */
public fun CallExpression.jSXExpressionContainer(block: JSXExpressionContainer.() -> Unit):
 ...
 */
public fun CallExpression.jSXAttribute(block: JSXAttribute.() -> Unit): JSXAttribute =
 ...
 */
public fun CallExpression.jSXText(block: JSXText.() -> Unit): JSXText = JSXText().apply(block)
 ...
 */
public fun CallExpression.jSXOpeningFragment(block: JSXOpeningFragment.() -> Unit):
 ...
 */
public fun CallExpression.jSXClosingFragment(block: JSXClosingFragment.() -> Unit):
 ...
 */
public fun CallExpression.exportDefaultExpression(block: ExportDefaultExpression.() -> Unit):
 ...
 */
public fun CallExpression.exportDeclaration(block: ExportDeclaration.() -> Unit): ExportDeclaration
 ...
 */
public fun CallExpression.importDeclaration(block: ImportDeclaration.() -> Unit): ImportDeclaration
 ...
 */
public fun CallExpression.exportAllDeclaration(block: ExportAllDeclaration.() -> Unit):
 ...
 */
public fun CallExpression.exportNamedDeclaration(block: ExportNamedDeclaration.() -> Unit):
 ...
 */
public fun CallExpression.exportDefaultDeclaration(block: ExportDefaultDeclaration.() -> Unit):
 ...
 */
public fun CallExpression.importDefaultSpecifier(block: ImportDefaultSpecifier.() -> Unit):
 ...
 */
public fun CallExpression.importNamespaceSpecifier(block: ImportNamespaceSpecifier.() -> Unit):
 ...
 */
public fun CallExpression.namedImportSpecifier(block: NamedImportSpecifier.() -> Unit):
 ...
 */
public fun CallExpression.exportNamespaceSpecifier(block: ExportNamespaceSpecifier.() -> Unit):
 ...
 */
public fun CallExpression.exportDefaultSpecifier(block: ExportDefaultSpecifier.() -> Unit):
 ...
 */
public fun CallExpression.namedExportSpecifier(block: NamedExportSpecifier.() -> Unit):
 ...
 */
public fun CallExpression.module(block: Module.() -> Unit): Module = Module().apply(block)

/**
 * CallExpression#callee: Node?
 * extension function for create Node? -> Script
 */
public fun CallExpression.script(block: Script.() -> Unit): Script = Script().apply(block)

/**
 * CallExpression#callee: Node?
 * extension function for create Node? -> KeyValuePatternProperty
 */
public fun CallExpression.keyValuePatternProperty(block: KeyValuePatternProperty.() -> Unit):
 ...
 */
public fun CallExpression.assignmentPatternProperty(block: AssignmentPatternProperty.() -> Unit):
 ...
 */
public fun CallExpression.assignmentProperty(block: AssignmentProperty.() -> Unit):
 ...
 */
public fun CallExpression.expressionStatement(block: ExpressionStatement.() -> Unit):
 ...
 */
public fun CallExpression.emptyStatement(block: EmptyStatement.() -> Unit): EmptyStatement =
 ...
 */
public fun CallExpression.debuggerStatement(block: DebuggerStatement.() -> Unit): DebuggerStatement
 ...
 */
public fun CallExpression.withStatement(block: WithStatement.() -> Unit): WithStatement =
 ...
 */
public fun CallExpression.returnStatement(block: ReturnStatement.() -> Unit): ReturnStatement =
 ...
 */
public fun CallExpression.labeledStatement(block: LabeledStatement.() -> Unit): LabeledStatement =
 ...
 */
public fun CallExpression.breakStatement(block: BreakStatement.() -> Unit): BreakStatement =
 ...
 */
public fun CallExpression.continueStatement(block: ContinueStatement.() -> Unit): ContinueStatement
 ...
 */
public fun CallExpression.ifStatement(block: IfStatement.() -> Unit): IfStatement =
 ...
 */
public fun CallExpression.switchStatement(block: SwitchStatement.() -> Unit): SwitchStatement =
 ...
 */
public fun CallExpression.throwStatement(block: ThrowStatement.() -> Unit): ThrowStatement =
 ...
 */
public fun CallExpression.tryStatement(block: TryStatement.() -> Unit): TryStatement =
 ...
 */
public fun CallExpression.whileStatement(block: WhileStatement.() -> Unit): WhileStatement =
 ...
 */
public fun CallExpression.doWhileStatement(block: DoWhileStatement.() -> Unit): DoWhileStatement =
 ...
 */
public fun CallExpression.forStatement(block: ForStatement.() -> Unit): ForStatement =
 ...
 */
public fun CallExpression.forInStatement(block: ForInStatement.() -> Unit): ForInStatement =
 ...
 */
public fun CallExpression.forOfStatement(block: ForOfStatement.() -> Unit): ForOfStatement =
 ...
 */
public fun CallExpression.switchCase(block: SwitchCase.() -> Unit): SwitchCase =
 ...
 */
public fun CallExpression.catchClause(block: CatchClause.() -> Unit): CatchClause =
 ...
 */
public fun CallExpression.tsTypeAnnotation(block: TsTypeAnnotation.() -> Unit): TsTypeAnnotation =
 ...
 */
public fun CallExpression.tsTypeParameterDeclaration(block: TsTypeParameterDeclaration.() -> Unit):
 ...
 */
public fun CallExpression.tsTypeParameter(block: TsTypeParameter.() -> Unit): TsTypeParameter =
 ...
 */
public fun CallExpression.tsParameterProperty(block: TsParameterProperty.() -> Unit):
 ...
 */
public fun CallExpression.tsQualifiedName(block: TsQualifiedName.() -> Unit): TsQualifiedName =
 ...
 */
public fun CallExpression.tsCallSignatureDeclaration(block: TsCallSignatureDeclaration.() -> Unit):
 ...
 */
public
    fun CallExpression.tsConstructSignatureDeclaration(block: TsConstructSignatureDeclaration.() -> Unit):
 ...
 */
public fun CallExpression.tsPropertySignature(block: TsPropertySignature.() -> Unit):
 ...
 */
public fun CallExpression.tsGetterSignature(block: TsGetterSignature.() -> Unit): TsGetterSignature
 ...
 */
public fun CallExpression.tsSetterSignature(block: TsSetterSignature.() -> Unit): TsSetterSignature
 ...
 */
public fun CallExpression.tsMethodSignature(block: TsMethodSignature.() -> Unit): TsMethodSignature
 ...
 */
public fun CallExpression.tsIndexSignature(block: TsIndexSignature.() -> Unit): TsIndexSignature =
 ...
 */
public fun CallExpression.tsKeywordType(block: TsKeywordType.() -> Unit): TsKeywordType =
 ...
 */
public fun CallExpression.tsThisType(block: TsThisType.() -> Unit): TsThisType =
 ...
 */
public fun CallExpression.tsFunctionType(block: TsFunctionType.() -> Unit): TsFunctionType =
 ...
 */
public fun CallExpression.tsConstructorType(block: TsConstructorType.() -> Unit): TsConstructorType
 ...
 */
public fun CallExpression.tsTypeReference(block: TsTypeReference.() -> Unit): TsTypeReference =
 ...
 */
public fun CallExpression.tsTypePredicate(block: TsTypePredicate.() -> Unit): TsTypePredicate =
 ...
 */
public fun CallExpression.tsImportType(block: TsImportType.() -> Unit): TsImportType =
 ...
 */
public fun CallExpression.tsTypeQuery(block: TsTypeQuery.() -> Unit): TsTypeQuery =
 ...
 */
public fun CallExpression.tsTypeLiteral(block: TsTypeLiteral.() -> Unit): TsTypeLiteral =
 ...
 */
public fun CallExpression.tsArrayType(block: TsArrayType.() -> Unit): TsArrayType =
 ...
 */
public fun CallExpression.tsTupleType(block: TsTupleType.() -> Unit): TsTupleType =
 ...
 */
public fun CallExpression.tsTupleElement(block: TsTupleElement.() -> Unit): TsTupleElement =
 ...
 */
public fun CallExpression.tsOptionalType(block: TsOptionalType.() -> Unit): TsOptionalType =
 ...
 */
public fun CallExpression.tsRestType(block: TsRestType.() -> Unit): TsRestType =
 ...
 */
public fun CallExpression.tsUnionType(block: TsUnionType.() -> Unit): TsUnionType =
 ...
 */
public fun CallExpression.tsIntersectionType(block: TsIntersectionType.() -> Unit):
 ...
 */
public fun CallExpression.tsConditionalType(block: TsConditionalType.() -> Unit): TsConditionalType
 ...
 */
public fun CallExpression.tsInferType(block: TsInferType.() -> Unit): TsInferType =
 ...
 */
public fun CallExpression.tsParenthesizedType(block: TsParenthesizedType.() -> Unit):
 ...
 */
public fun CallExpression.tsTypeOperator(block: TsTypeOperator.() -> Unit): TsTypeOperator =
 ...
 */
public fun CallExpression.tsIndexedAccessType(block: TsIndexedAccessType.() -> Unit):
 ...
 */
public fun CallExpression.tsMappedType(block: TsMappedType.() -> Unit): TsMappedType =
 ...
 */
public fun CallExpression.tsLiteralType(block: TsLiteralType.() -> Unit): TsLiteralType =
 ...
 */
public fun CallExpression.tsInterfaceBody(block: TsInterfaceBody.() -> Unit): TsInterfaceBody =
 ...
 */
public
    fun CallExpression.tsExpressionWithTypeArguments(block: TsExpressionWithTypeArguments.() -> Unit):
 ...
 */
public fun CallExpression.tsTypeAliasDeclaration(block: TsTypeAliasDeclaration.() -> Unit):
 ...
 */
public fun CallExpression.tsEnumDeclaration(block: TsEnumDeclaration.() -> Unit): TsEnumDeclaration
 ...
 */
public fun CallExpression.tsEnumMember(block: TsEnumMember.() -> Unit): TsEnumMember =
 ...
 */
public fun CallExpression.tsModuleDeclaration(block: TsModuleDeclaration.() -> Unit):
 ...
 */
public fun CallExpression.tsModuleBlock(block: TsModuleBlock.() -> Unit): TsModuleBlock =
 ...
 */
public fun CallExpression.tsNamespaceDeclaration(block: TsNamespaceDeclaration.() -> Unit):
 ...
 */
public fun CallExpression.tsImportEqualsDeclaration(block: TsImportEqualsDeclaration.() -> Unit):
 ...
 */
public fun CallExpression.tsExternalModuleReference(block: TsExternalModuleReference.() -> Unit):
 ...
 */
public fun CallExpression.tsExportAssignment(block: TsExportAssignment.() -> Unit):
 ...
 */
public
    fun CallExpression.tsNamespaceExportDeclaration(block: TsNamespaceExportDeclaration.() -> Unit):
 ...
 */
public fun CallExpression.invalid(block: Invalid.() -> Unit): Invalid = Invalid().apply(block)

/**
 * CallExpression#callee: Node?
 * extension function for create Node? -> ClassProperty
 */
public fun CallExpression.classProperty(block: ClassProperty.() -> Unit): ClassProperty =
 ...
 */
public fun CallExpression.privateProperty(block: PrivateProperty.() -> Unit): PrivateProperty =
 ...
 */
public fun CallExpression.classMethod(block: ClassMethod.() -> Unit): ClassMethod =
 ...
 */
public fun CallExpression.privateMethod(block: PrivateMethod.() -> Unit): PrivateMethod =
 ...
 */
public fun CallExpression.templateElement(block: TemplateElement.() -> Unit): TemplateElement =
 ...
 */
public fun CallExpression.objectPattern(block: ObjectPattern.() -> Unit): ObjectPattern =
 ...
 */
public fun CallExpression.assignmentPattern(block: AssignmentPattern.() -> Unit): AssignmentPattern
 ...
 */
public fun CallExpression.restElement(block: RestElement.() -> Unit): RestElement =
 ...
 */
public fun CallExpression.keyValueProperty(block: KeyValueProperty.() -> Unit): KeyValueProperty =
 ...
 */
public fun CallExpression.getterProperty(block: GetterProperty.() -> Unit): GetterProperty =
 ...
 */
public fun CallExpression.setterProperty(block: SetterProperty.() -> Unit): SetterProperty =
 ...
 * extension function for create Array<Argument>? -> Argument
 */
public fun CallExpression.argument(block: Argument.() -> Unit): Argument = Argument().apply(block)

// Auto-generated file. Do not edit. Generated at: 2025-11-20T00:09:39.39079
 ...
 */
public fun TsInstantiation.invalid(block: Invalid.() -> Unit): Invalid = Invalid().apply(block)

/**
 * TsInstantiation#expression: Expression?
 * extension function for create Expression? -> JSXText
 */
public fun TsInstantiation.jSXText(block: JSXText.() -> Unit): JSXText = JSXText().apply(block)

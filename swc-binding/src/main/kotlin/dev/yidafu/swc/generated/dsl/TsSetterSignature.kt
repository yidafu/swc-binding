 ...
 */
public fun TsSetterSignature.invalid(block: Invalid.() -> Unit): Invalid = Invalid().apply(block)

/**
 * TsSetterSignature#key: Expression?
 * extension function for create Expression? -> JSXText
 */
public fun TsSetterSignature.jSXText(block: JSXText.() -> Unit): JSXText = JSXText().apply(block)
 ...
 * extension function for create TsFnParameter? -> ArrayPattern
 */
...
/**
 * TsSetterSignature#param: TsFnParameter?
 * extension function for create TsFnParameter? -> ObjectPattern
 */
...
/**
 * TsSetterSignature#param: TsFnParameter?
 * extension function for create TsFnParameter? -> RestElement
 */

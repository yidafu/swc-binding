 ...
 */
public fun DoWhileStatement.invalid(block: Invalid.() -> Unit): Invalid = Invalid().apply(block)

/**
 * DoWhileStatement#test: Expression?
 * extension function for create Expression? -> JSXText
 */
public fun DoWhileStatement.jSXText(block: JSXText.() -> Unit): JSXText = JSXText().apply(block)

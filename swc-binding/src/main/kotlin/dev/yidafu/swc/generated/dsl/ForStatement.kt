// Auto-generated file. Do not edit. Generated at: 2025-11-20T00:09:39.368569
...
/**
 * ForStatement#init: Node?
 * extension function for create Node? -> Constructor
 */
public fun ForStatement.`constructor`(block: Constructor.() -> Unit): Constructor =
 ...
 */
public fun ForStatement.staticBlock(block: StaticBlock.() -> Unit): StaticBlock =
 ...
 */
public fun ForStatement.decorator(block: Decorator.() -> Unit): Decorator = Decorator().apply(block)
 ...
 */
public fun ForStatement.spreadElement(block: SpreadElement.() -> Unit): SpreadElement =
 ...
 */
public fun ForStatement.jsSuper(block: JsSuper.() -> Unit): JsSuper = JsSuper().apply(block)

/**
 * ForStatement#init: Node?
 * extension function for create Node? -> JsImport
 */
public fun ForStatement.jsImport(block: JsImport.() -> Unit): JsImport = JsImport().apply(block)
 ...
 */
public fun ForStatement.jSXExpressionContainer(block: JSXExpressionContainer.() -> Unit):
 ...
 */
public fun ForStatement.jSXSpreadChild(block: JSXSpreadChild.() -> Unit): JSXSpreadChild =
 ...
 */
public fun ForStatement.jSXAttribute(block: JSXAttribute.() -> Unit): JSXAttribute =
 ...
 */
public fun ForStatement.jSXText(block: JSXText.() -> Unit): JSXText = JSXText().apply(block)
 ...
 */
public fun ForStatement.jSXOpeningFragment(block: JSXOpeningFragment.() -> Unit): JSXOpeningFragment
 ...
 */
public fun ForStatement.jSXClosingFragment(block: JSXClosingFragment.() -> Unit): JSXClosingFragment
 ...
 */
public fun ForStatement.exportDefaultExpression(block: ExportDefaultExpression.() -> Unit):
 ...
 */
public fun ForStatement.exportDeclaration(block: ExportDeclaration.() -> Unit): ExportDeclaration =
 ...
 */
public fun ForStatement.importDeclaration(block: ImportDeclaration.() -> Unit): ImportDeclaration =
 ...
 */
public fun ForStatement.exportAllDeclaration(block: ExportAllDeclaration.() -> Unit):
 ...
 */
public fun ForStatement.exportNamedDeclaration(block: ExportNamedDeclaration.() -> Unit):
 ...
 */
public fun ForStatement.exportDefaultDeclaration(block: ExportDefaultDeclaration.() -> Unit):
 ...
 */
public fun ForStatement.importDefaultSpecifier(block: ImportDefaultSpecifier.() -> Unit):
 ...
 */
public fun ForStatement.importNamespaceSpecifier(block: ImportNamespaceSpecifier.() -> Unit):
 ...
 */
public fun ForStatement.namedImportSpecifier(block: NamedImportSpecifier.() -> Unit):
 ...
 */
public fun ForStatement.exportNamespaceSpecifier(block: ExportNamespaceSpecifier.() -> Unit):
 ...
 */
public fun ForStatement.exportDefaultSpecifier(block: ExportDefaultSpecifier.() -> Unit):
 ...
 */
public fun ForStatement.namedExportSpecifier(block: NamedExportSpecifier.() -> Unit):
 ...
 */
public fun ForStatement.module(block: Module.() -> Unit): Module = Module().apply(block)

/**
 * ForStatement#init: Node?
 * extension function for create Node? -> Script
 */
public fun ForStatement.script(block: Script.() -> Unit): Script = Script().apply(block)

/**
 * ForStatement#init: Node?
 * extension function for create Node? -> KeyValuePatternProperty
 */
public fun ForStatement.keyValuePatternProperty(block: KeyValuePatternProperty.() -> Unit):
 ...
 */
public fun ForStatement.assignmentPatternProperty(block: AssignmentPatternProperty.() -> Unit):
 ...
 */
public fun ForStatement.assignmentProperty(block: AssignmentProperty.() -> Unit): AssignmentProperty
 ...
 */
public fun ForStatement.computedPropName(block: ComputedPropName.() -> Unit): ComputedPropName =
...
/**
 * ForStatement#body: Statement?
 * extension function for create Statement? -> LabeledStatement
 */
 ...
 */
public fun ForStatement.switchCase(block: SwitchCase.() -> Unit): SwitchCase =
 ...
 */
public fun ForStatement.catchClause(block: CatchClause.() -> Unit): CatchClause =
 ...
 */
public fun ForStatement.tsTypeAnnotation(block: TsTypeAnnotation.() -> Unit): TsTypeAnnotation =
 ...
 */
public fun ForStatement.tsTypeParameterDeclaration(block: TsTypeParameterDeclaration.() -> Unit):
 ...
 */
public fun ForStatement.tsTypeParameter(block: TsTypeParameter.() -> Unit): TsTypeParameter =
 ...
 */
public
    fun ForStatement.tsTypeParameterInstantiation(block: TsTypeParameterInstantiation.() -> Unit):
 ...
 */
public fun ForStatement.tsParameterProperty(block: TsParameterProperty.() -> Unit):
 ...
 */
public fun ForStatement.tsQualifiedName(block: TsQualifiedName.() -> Unit): TsQualifiedName =
 ...
 */
public fun ForStatement.tsCallSignatureDeclaration(block: TsCallSignatureDeclaration.() -> Unit):
 ...
 */
public
    fun ForStatement.tsConstructSignatureDeclaration(block: TsConstructSignatureDeclaration.() -> Unit):
 ...
 */
public fun ForStatement.tsPropertySignature(block: TsPropertySignature.() -> Unit):
 ...
 */
public fun ForStatement.tsGetterSignature(block: TsGetterSignature.() -> Unit): TsGetterSignature =
 ...
 */
public fun ForStatement.tsSetterSignature(block: TsSetterSignature.() -> Unit): TsSetterSignature =
 ...
 */
public fun ForStatement.tsMethodSignature(block: TsMethodSignature.() -> Unit): TsMethodSignature =
 ...
 */
public fun ForStatement.tsIndexSignature(block: TsIndexSignature.() -> Unit): TsIndexSignature =
 ...
 */
public fun ForStatement.tsKeywordType(block: TsKeywordType.() -> Unit): TsKeywordType =
 ...
 */
public fun ForStatement.tsThisType(block: TsThisType.() -> Unit): TsThisType =
 ...
 */
public fun ForStatement.tsFunctionType(block: TsFunctionType.() -> Unit): TsFunctionType =
 ...
 */
public fun ForStatement.tsConstructorType(block: TsConstructorType.() -> Unit): TsConstructorType =
 ...
 */
public fun ForStatement.tsTypeReference(block: TsTypeReference.() -> Unit): TsTypeReference =
 ...
 */
public fun ForStatement.tsTypePredicate(block: TsTypePredicate.() -> Unit): TsTypePredicate =
 ...
 */
public fun ForStatement.tsImportType(block: TsImportType.() -> Unit): TsImportType =
 ...
 */
public fun ForStatement.tsTypeQuery(block: TsTypeQuery.() -> Unit): TsTypeQuery =
 ...
 */
public fun ForStatement.tsTypeLiteral(block: TsTypeLiteral.() -> Unit): TsTypeLiteral =
 ...
 */
public fun ForStatement.tsArrayType(block: TsArrayType.() -> Unit): TsArrayType =
 ...
 */
public fun ForStatement.tsTupleType(block: TsTupleType.() -> Unit): TsTupleType =
 ...
 */
public fun ForStatement.tsTupleElement(block: TsTupleElement.() -> Unit): TsTupleElement =
 ...
 */
public fun ForStatement.tsOptionalType(block: TsOptionalType.() -> Unit): TsOptionalType =
 ...
 */
public fun ForStatement.tsRestType(block: TsRestType.() -> Unit): TsRestType =
 ...
 */
public fun ForStatement.tsUnionType(block: TsUnionType.() -> Unit): TsUnionType =
 ...
 */
public fun ForStatement.tsIntersectionType(block: TsIntersectionType.() -> Unit): TsIntersectionType
 ...
 */
public fun ForStatement.tsConditionalType(block: TsConditionalType.() -> Unit): TsConditionalType =
 ...
 */
public fun ForStatement.tsInferType(block: TsInferType.() -> Unit): TsInferType =
 ...
 */
public fun ForStatement.tsParenthesizedType(block: TsParenthesizedType.() -> Unit):
 ...
 */
public fun ForStatement.tsTypeOperator(block: TsTypeOperator.() -> Unit): TsTypeOperator =
 ...
 */
public fun ForStatement.tsIndexedAccessType(block: TsIndexedAccessType.() -> Unit):
 ...
 */
public fun ForStatement.tsMappedType(block: TsMappedType.() -> Unit): TsMappedType =
 ...
 */
public fun ForStatement.tsLiteralType(block: TsLiteralType.() -> Unit): TsLiteralType =
 ...
 */
public fun ForStatement.tsInterfaceBody(block: TsInterfaceBody.() -> Unit): TsInterfaceBody =
 ...
 */
public
    fun ForStatement.tsExpressionWithTypeArguments(block: TsExpressionWithTypeArguments.() -> Unit):
 ...
 */
public fun ForStatement.tsEnumMember(block: TsEnumMember.() -> Unit): TsEnumMember =
 ...
 */
public fun ForStatement.tsModuleBlock(block: TsModuleBlock.() -> Unit): TsModuleBlock =
 ...
 */
public fun ForStatement.tsNamespaceDeclaration(block: TsNamespaceDeclaration.() -> Unit):
 ...
 */
public fun ForStatement.tsImportEqualsDeclaration(block: TsImportEqualsDeclaration.() -> Unit):
 ...
 */
public fun ForStatement.tsExternalModuleReference(block: TsExternalModuleReference.() -> Unit):
 ...
 */
public fun ForStatement.tsExportAssignment(block: TsExportAssignment.() -> Unit): TsExportAssignment
 ...
 */
public
    fun ForStatement.tsNamespaceExportDeclaration(block: TsNamespaceExportDeclaration.() -> Unit):
 ...
 */
public fun ForStatement.invalid(block: Invalid.() -> Unit): Invalid = Invalid().apply(block)

/**
 * ForStatement#init: Node?
 * extension function for create Node? -> ClassProperty
 */
public fun ForStatement.classProperty(block: ClassProperty.() -> Unit): ClassProperty =
 ...
 */
public fun ForStatement.privateProperty(block: PrivateProperty.() -> Unit): PrivateProperty =
 ...
 */
public fun ForStatement.classMethod(block: ClassMethod.() -> Unit): ClassMethod =
 ...
 */
public fun ForStatement.privateMethod(block: PrivateMethod.() -> Unit): PrivateMethod =
 ...
 */
public fun ForStatement.templateElement(block: TemplateElement.() -> Unit): TemplateElement =
 ...
 */
public fun ForStatement.arrayPattern(block: ArrayPattern.() -> Unit): ArrayPattern =
 ...
 */
public fun ForStatement.objectPattern(block: ObjectPattern.() -> Unit): ObjectPattern =
 ...
 */
public fun ForStatement.assignmentPattern(block: AssignmentPattern.() -> Unit): AssignmentPattern =
 ...
 */
public fun ForStatement.restElement(block: RestElement.() -> Unit): RestElement =
 ...
 */
public fun ForStatement.keyValueProperty(block: KeyValueProperty.() -> Unit): KeyValueProperty =
 ...
 */
public fun ForStatement.getterProperty(block: GetterProperty.() -> Unit): GetterProperty =
 ...
 */
public fun ForStatement.setterProperty(block: SetterProperty.() -> Unit): SetterProperty =
 ...
 */
public fun ForStatement.methodProperty(block: MethodProperty.() -> Unit): MethodProperty =
 ...
 */
public fun ForStatement.`param`(block: Param.() -> Unit): Param = ParamImpl().apply(block)

/**
 * ForStatement#init: Node?
 * extension function for create Node? -> VariableDeclarator
 */
public fun ForStatement.variableDeclarator(block: VariableDeclarator.() -> Unit): VariableDeclarator
 ...
 */
public fun ForStatement.jSXOpeningElement(block: JSXOpeningElement.() -> Unit): JSXOpeningElement =
 ...
 */
public fun ForStatement.jSXClosingElement(block: JSXClosingElement.() -> Unit): JSXClosingElement =
 ...
 */
public fun ForStatement.tsTemplateLiteralType(block: TsTemplateLiteralType.() -> Unit):
 ...
 */
public fun ForStatement.bindingIdentifier(block: BindingIdentifier.() -> Unit): BindingIdentifier =

 ...
 */
public fun IfStatement.invalid(block: Invalid.() -> Unit): Invalid = Invalid().apply(block)

/**
 * IfStatement#test: Expression?
 * extension function for create Expression? -> JSXText
 */
public fun IfStatement.jSXText(block: JSXText.() -> Unit): JSXText = JSXText().apply(block)

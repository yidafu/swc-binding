...
/**
 * ObjectExpression#properties: Array<Node>?
 * extension function for create Array<Node>? -> Constructor
 */
public fun ObjectExpression.`constructor`(block: Constructor.() -> Unit): Constructor =
 ...
 */
public fun ObjectExpression.staticBlock(block: StaticBlock.() -> Unit): StaticBlock =
 ...
 */
public fun ObjectExpression.decorator(block: Decorator.() -> Unit): Decorator =
 ...
 */
public fun ObjectExpression.classDeclaration(block: ClassDeclaration.() -> Unit): ClassDeclaration =
 ...
 */
public fun ObjectExpression.jsSuper(block: JsSuper.() -> Unit): JsSuper = JsSuper().apply(block)

/**
 * ObjectExpression#properties: Array<Node>?
 * extension function for create Array<Node>? -> JsImport
 */
public fun ObjectExpression.jsImport(block: JsImport.() -> Unit): JsImport = JsImport().apply(block)

/**
 * ObjectExpression#properties: Array<Node>?
 * extension function for create Array<Node>? -> MetaProperty
 */
public fun ObjectExpression.metaProperty(block: MetaProperty.() -> Unit): MetaProperty =
 ...
 */
public fun ObjectExpression.jSXMemberExpression(block: JSXMemberExpression.() -> Unit):
 ...
 */
public fun ObjectExpression.jSXNamespacedName(block: JSXNamespacedName.() -> Unit):
 ...
 */
public fun ObjectExpression.jSXEmptyExpression(block: JSXEmptyExpression.() -> Unit):
 ...
 */
public fun ObjectExpression.jSXExpressionContainer(block: JSXExpressionContainer.() -> Unit):
 ...
 */
public fun ObjectExpression.jSXAttribute(block: JSXAttribute.() -> Unit): JSXAttribute =
 ...
 */
public fun ObjectExpression.jSXText(block: JSXText.() -> Unit): JSXText = JSXText().apply(block)

/**
 * ObjectExpression#properties: Array<Node>?
 * extension function for create Array<Node>? -> JSXElement
 */
public fun ObjectExpression.jSXElement(block: JSXElement.() -> Unit): JSXElement =
 ...
 */
public fun ObjectExpression.jSXFragment(block: JSXFragment.() -> Unit): JSXFragment =
 ...
 */
public fun ObjectExpression.jSXOpeningFragment(block: JSXOpeningFragment.() -> Unit):
 ...
 */
public fun ObjectExpression.jSXClosingFragment(block: JSXClosingFragment.() -> Unit):
 ...
 */
public fun ObjectExpression.stringLiteral(block: StringLiteral.() -> Unit): StringLiteral =
 ...
 */
public fun ObjectExpression.booleanLiteral(block: BooleanLiteral.() -> Unit): BooleanLiteral =
 ...
 */
public fun ObjectExpression.nullLiteral(block: NullLiteral.() -> Unit): NullLiteral =
 ...
 */
public fun ObjectExpression.regExpLiteral(block: RegExpLiteral.() -> Unit): RegExpLiteral =
 ...
 */
public fun ObjectExpression.numericLiteral(block: NumericLiteral.() -> Unit): NumericLiteral =
 ...
 */
public fun ObjectExpression.bigIntLiteral(block: BigIntLiteral.() -> Unit): BigIntLiteral =
 ...
 */
public fun ObjectExpression.exportDefaultExpression(block: ExportDefaultExpression.() -> Unit):
 ...
 */
public fun ObjectExpression.exportDeclaration(block: ExportDeclaration.() -> Unit):
 ...
 */
public fun ObjectExpression.importDeclaration(block: ImportDeclaration.() -> Unit):
 ...
 */
public fun ObjectExpression.exportAllDeclaration(block: ExportAllDeclaration.() -> Unit):
 ...
 */
public fun ObjectExpression.exportNamedDeclaration(block: ExportNamedDeclaration.() -> Unit):
 ...
 */
public fun ObjectExpression.exportDefaultDeclaration(block: ExportDefaultDeclaration.() -> Unit):
 ...
 */
public fun ObjectExpression.importDefaultSpecifier(block: ImportDefaultSpecifier.() -> Unit):
 ...
 */
public fun ObjectExpression.importNamespaceSpecifier(block: ImportNamespaceSpecifier.() -> Unit):
 ...
 */
public fun ObjectExpression.namedImportSpecifier(block: NamedImportSpecifier.() -> Unit):
 ...
 */
public fun ObjectExpression.exportNamespaceSpecifier(block: ExportNamespaceSpecifier.() -> Unit):
 ...
 */
public fun ObjectExpression.exportDefaultSpecifier(block: ExportDefaultSpecifier.() -> Unit):
 ...
 */
public fun ObjectExpression.namedExportSpecifier(block: NamedExportSpecifier.() -> Unit):
 ...
 */
public fun ObjectExpression.module(block: Module.() -> Unit): Module = Module().apply(block)

/**
 * ObjectExpression#properties: Array<Node>?
 * extension function for create Array<Node>? -> Script
 */
public fun ObjectExpression.script(block: Script.() -> Unit): Script = Script().apply(block)

/**
 * ObjectExpression#properties: Array<Node>?
 * extension function for create Array<Node>? -> KeyValuePatternProperty
 */
public fun ObjectExpression.keyValuePatternProperty(block: KeyValuePatternProperty.() -> Unit):
 ...
 */
public fun ObjectExpression.assignmentPatternProperty(block: AssignmentPatternProperty.() -> Unit):
 ...
 */
public fun ObjectExpression.expressionStatement(block: ExpressionStatement.() -> Unit):
 ...
 */
public fun ObjectExpression.emptyStatement(block: EmptyStatement.() -> Unit): EmptyStatement =
 ...
 */
public fun ObjectExpression.debuggerStatement(block: DebuggerStatement.() -> Unit):
 ...
 */
public fun ObjectExpression.withStatement(block: WithStatement.() -> Unit): WithStatement =
 ...
 */
public fun ObjectExpression.returnStatement(block: ReturnStatement.() -> Unit): ReturnStatement =
 ...
 */
public fun ObjectExpression.labeledStatement(block: LabeledStatement.() -> Unit): LabeledStatement =
 ...
 */
public fun ObjectExpression.breakStatement(block: BreakStatement.() -> Unit): BreakStatement =
 ...
 */
public fun ObjectExpression.continueStatement(block: ContinueStatement.() -> Unit):
 ...
 */
public fun ObjectExpression.ifStatement(block: IfStatement.() -> Unit): IfStatement =
 ...
 */
public fun ObjectExpression.switchStatement(block: SwitchStatement.() -> Unit): SwitchStatement =
 ...
 */
public fun ObjectExpression.throwStatement(block: ThrowStatement.() -> Unit): ThrowStatement =
 ...
 */
public fun ObjectExpression.tryStatement(block: TryStatement.() -> Unit): TryStatement =
 ...
 */
public fun ObjectExpression.whileStatement(block: WhileStatement.() -> Unit): WhileStatement =
 ...
 */
public fun ObjectExpression.doWhileStatement(block: DoWhileStatement.() -> Unit): DoWhileStatement =
 ...
 */
public fun ObjectExpression.forStatement(block: ForStatement.() -> Unit): ForStatement =
 ...
 */
public fun ObjectExpression.forInStatement(block: ForInStatement.() -> Unit): ForInStatement =
 ...
 */
public fun ObjectExpression.forOfStatement(block: ForOfStatement.() -> Unit): ForOfStatement =
 ...
 */
public fun ObjectExpression.switchCase(block: SwitchCase.() -> Unit): SwitchCase =
 ...
 */
public fun ObjectExpression.catchClause(block: CatchClause.() -> Unit): CatchClause =
 ...
 */
public fun ObjectExpression.tsTypeAnnotation(block: TsTypeAnnotation.() -> Unit): TsTypeAnnotation =
 ...
 */
public
    fun ObjectExpression.tsTypeParameterDeclaration(block: TsTypeParameterDeclaration.() -> Unit):
 ...
 */
public fun ObjectExpression.tsTypeParameter(block: TsTypeParameter.() -> Unit): TsTypeParameter =
 ...
 */
public
    fun ObjectExpression.tsTypeParameterInstantiation(block: TsTypeParameterInstantiation.() -> Unit):
 ...
 */
public fun ObjectExpression.tsParameterProperty(block: TsParameterProperty.() -> Unit):
 ...
 */
public fun ObjectExpression.tsQualifiedName(block: TsQualifiedName.() -> Unit): TsQualifiedName =
 ...
 */
public
    fun ObjectExpression.tsCallSignatureDeclaration(block: TsCallSignatureDeclaration.() -> Unit):
 ...
 */
public
    fun ObjectExpression.tsConstructSignatureDeclaration(block: TsConstructSignatureDeclaration.() -> Unit):
 ...
 */
public fun ObjectExpression.tsPropertySignature(block: TsPropertySignature.() -> Unit):
 ...
 */
public fun ObjectExpression.tsGetterSignature(block: TsGetterSignature.() -> Unit):
 ...
 */
public fun ObjectExpression.tsSetterSignature(block: TsSetterSignature.() -> Unit):
 ...
 */
public fun ObjectExpression.tsMethodSignature(block: TsMethodSignature.() -> Unit):
 ...
 */
public fun ObjectExpression.tsIndexSignature(block: TsIndexSignature.() -> Unit): TsIndexSignature =
 ...
 */
public fun ObjectExpression.tsKeywordType(block: TsKeywordType.() -> Unit): TsKeywordType =
 ...
 */
public fun ObjectExpression.tsThisType(block: TsThisType.() -> Unit): TsThisType =
 ...
 */
public fun ObjectExpression.tsFunctionType(block: TsFunctionType.() -> Unit): TsFunctionType =
 ...
 */
public fun ObjectExpression.tsConstructorType(block: TsConstructorType.() -> Unit):
 ...
 */
public fun ObjectExpression.tsTypeReference(block: TsTypeReference.() -> Unit): TsTypeReference =
 ...
 */
public fun ObjectExpression.tsTypePredicate(block: TsTypePredicate.() -> Unit): TsTypePredicate =
 ...
 */
public fun ObjectExpression.tsImportType(block: TsImportType.() -> Unit): TsImportType =
 ...
 */
public fun ObjectExpression.tsTypeQuery(block: TsTypeQuery.() -> Unit): TsTypeQuery =
 ...
 */
public fun ObjectExpression.tsTypeLiteral(block: TsTypeLiteral.() -> Unit): TsTypeLiteral =
 ...
 */
public fun ObjectExpression.tsArrayType(block: TsArrayType.() -> Unit): TsArrayType =
 ...
 */
public fun ObjectExpression.tsTupleType(block: TsTupleType.() -> Unit): TsTupleType =
 ...
 */
public fun ObjectExpression.tsTupleElement(block: TsTupleElement.() -> Unit): TsTupleElement =
 ...
 */
public fun ObjectExpression.tsOptionalType(block: TsOptionalType.() -> Unit): TsOptionalType =
 ...
 */
public fun ObjectExpression.tsRestType(block: TsRestType.() -> Unit): TsRestType =
 ...
 */
public fun ObjectExpression.tsUnionType(block: TsUnionType.() -> Unit): TsUnionType =
 ...
 */
public fun ObjectExpression.tsIntersectionType(block: TsIntersectionType.() -> Unit):
 ...
 */
public fun ObjectExpression.tsConditionalType(block: TsConditionalType.() -> Unit):
 ...
 */
public fun ObjectExpression.tsInferType(block: TsInferType.() -> Unit): TsInferType =
 ...
 */
public fun ObjectExpression.tsParenthesizedType(block: TsParenthesizedType.() -> Unit):
 ...
 */
public fun ObjectExpression.tsTypeOperator(block: TsTypeOperator.() -> Unit): TsTypeOperator =
 ...
 */
public fun ObjectExpression.tsIndexedAccessType(block: TsIndexedAccessType.() -> Unit):
 ...
 */
public fun ObjectExpression.tsMappedType(block: TsMappedType.() -> Unit): TsMappedType =
 ...
 */
public fun ObjectExpression.tsLiteralType(block: TsLiteralType.() -> Unit): TsLiteralType =
 ...
 */
public fun ObjectExpression.tsInterfaceBody(block: TsInterfaceBody.() -> Unit): TsInterfaceBody =
 ...
 */
public
    fun ObjectExpression.tsExpressionWithTypeArguments(block: TsExpressionWithTypeArguments.() -> Unit):
 ...
 */
public fun ObjectExpression.tsTypeAliasDeclaration(block: TsTypeAliasDeclaration.() -> Unit):
 ...
 */
public fun ObjectExpression.tsEnumDeclaration(block: TsEnumDeclaration.() -> Unit):
 ...
 */
public fun ObjectExpression.tsEnumMember(block: TsEnumMember.() -> Unit): TsEnumMember =
 ...
 */
public fun ObjectExpression.tsModuleDeclaration(block: TsModuleDeclaration.() -> Unit):
 ...
 */
public fun ObjectExpression.tsModuleBlock(block: TsModuleBlock.() -> Unit): TsModuleBlock =
 ...
 */
public fun ObjectExpression.tsNamespaceDeclaration(block: TsNamespaceDeclaration.() -> Unit):
 ...
 */
public fun ObjectExpression.tsImportEqualsDeclaration(block: TsImportEqualsDeclaration.() -> Unit):
 ...
 */
public fun ObjectExpression.tsExternalModuleReference(block: TsExternalModuleReference.() -> Unit):
 ...
 */
public fun ObjectExpression.tsExportAssignment(block: TsExportAssignment.() -> Unit):
 ...
 */
public
    fun ObjectExpression.tsNamespaceExportDeclaration(block: TsNamespaceExportDeclaration.() -> Unit):
 ...
 */
public fun ObjectExpression.tsInstantiation(block: TsInstantiation.() -> Unit): TsInstantiation =
 ...
 */
public fun ObjectExpression.invalid(block: Invalid.() -> Unit): Invalid = Invalid().apply(block)

/**
 * ObjectExpression#properties: Array<Node>?
 * extension function for create Array<Node>? -> ClassProperty
 */
public fun ObjectExpression.classProperty(block: ClassProperty.() -> Unit): ClassProperty =
 ...
 */
public fun ObjectExpression.privateProperty(block: PrivateProperty.() -> Unit): PrivateProperty =
 ...
 */
public fun ObjectExpression.classMethod(block: ClassMethod.() -> Unit): ClassMethod =
 ...
 */
public fun ObjectExpression.privateMethod(block: PrivateMethod.() -> Unit): PrivateMethod =
 ...
 */
public
    fun ObjectExpression.optionalChainingExpression(block: OptionalChainingExpression.() -> Unit):
 ...
 */
public fun ObjectExpression.thisExpression(block: ThisExpression.() -> Unit): ThisExpression =
 ...
 */
public fun ObjectExpression.arrayExpression(block: ArrayExpression.() -> Unit): ArrayExpression =
 ...
 */
public fun ObjectExpression.unaryExpression(block: UnaryExpression.() -> Unit): UnaryExpression =
 ...
 */
public fun ObjectExpression.updateExpression(block: UpdateExpression.() -> Unit): UpdateExpression =
 ...
 */
public fun ObjectExpression.binaryExpression(block: BinaryExpression.() -> Unit): BinaryExpression =
 ...
 */
public fun ObjectExpression.functionExpression(block: FunctionExpression.() -> Unit):
 ...
 */
public fun ObjectExpression.classExpression(block: ClassExpression.() -> Unit): ClassExpression =
 ...
 */
public fun ObjectExpression.assignmentExpression(block: AssignmentExpression.() -> Unit):
 ...
 */
public fun ObjectExpression.memberExpression(block: MemberExpression.() -> Unit): MemberExpression =
 ...
 */
public fun ObjectExpression.superPropExpression(block: SuperPropExpression.() -> Unit):
 ...
 */
public fun ObjectExpression.conditionalExpression(block: ConditionalExpression.() -> Unit):
 ...
 */
public fun ObjectExpression.callExpression(block: CallExpression.() -> Unit): CallExpression =
 ...
 */
public fun ObjectExpression.newExpression(block: NewExpression.() -> Unit): NewExpression =
 ...
 */
public fun ObjectExpression.sequenceExpression(block: SequenceExpression.() -> Unit):
 ...
 */
public fun ObjectExpression.arrowFunctionExpression(block: ArrowFunctionExpression.() -> Unit):
 ...
 */
public fun ObjectExpression.yieldExpression(block: YieldExpression.() -> Unit): YieldExpression =
 ...
 */
public fun ObjectExpression.awaitExpression(block: AwaitExpression.() -> Unit): AwaitExpression =
 ...
 */
public fun ObjectExpression.templateElement(block: TemplateElement.() -> Unit): TemplateElement =
 ...
 */
public fun ObjectExpression.parenthesisExpression(block: ParenthesisExpression.() -> Unit):
 ...
 */
public fun ObjectExpression.privateName(block: PrivateName.() -> Unit): PrivateName =
 ...
 */
public fun ObjectExpression.tsAsExpression(block: TsAsExpression.() -> Unit): TsAsExpression =
 ...
 */
public fun ObjectExpression.tsSatisfiesExpression(block: TsSatisfiesExpression.() -> Unit):
 ...
 */
public fun ObjectExpression.tsTypeAssertion(block: TsTypeAssertion.() -> Unit): TsTypeAssertion =
 ...
 */
public fun ObjectExpression.tsConstAssertion(block: TsConstAssertion.() -> Unit): TsConstAssertion =
 ...
 */
public fun ObjectExpression.tsNonNullExpression(block: TsNonNullExpression.() -> Unit):
 ...
 */
public fun ObjectExpression.objectPattern(block: ObjectPattern.() -> Unit): ObjectPattern =
 ...
 */
public fun ObjectExpression.assignmentPattern(block: AssignmentPattern.() -> Unit):
 ...
 */
public fun ObjectExpression.restElement(block: RestElement.() -> Unit): RestElement =

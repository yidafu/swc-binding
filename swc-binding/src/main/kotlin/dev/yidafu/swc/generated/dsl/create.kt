...
public fun createDecorator(block: Decorator.() -> Unit): Decorator = Decorator().apply(block)
...
public fun createAssignmentExpression(block: AssignmentExpression.() -> Unit): AssignmentExpression
    = AssignmentExpression().apply(block)
...
public fun createJsSuper(block: JsSuper.() -> Unit): JsSuper = JsSuper().apply(block)

public fun createJsImport(block: JsImport.() -> Unit): JsImport = JsImport().apply(block)
...
public fun createJSXText(block: JSXText.() -> Unit): JSXText = JSXText().apply(block)

public fun createJSXElement(block: JSXElement.() -> Unit): JSXElement = JSXElement().apply(block)
...
public fun createNamedImportSpecifier(block: NamedImportSpecifier.() -> Unit): NamedImportSpecifier
    = NamedImportSpecifier().apply(block)
...
public fun createNamedExportSpecifier(block: NamedExportSpecifier.() -> Unit): NamedExportSpecifier
    = NamedExportSpecifier().apply(block)

public fun createModule(block: Module.() -> Unit): Module = Module().apply(block)
...
public fun createSwitchCase(block: SwitchCase.() -> Unit): SwitchCase = SwitchCase().apply(block)
...
public fun createTsParameterProperty(block: TsParameterProperty.() -> Unit): TsParameterProperty =
    TsParameterProperty().apply(block)
...
public fun createTsPropertySignature(block: TsPropertySignature.() -> Unit): TsPropertySignature =
    TsPropertySignature().apply(block)
...
public fun createTsThisType(block: TsThisType.() -> Unit): TsThisType = TsThisType().apply(block)
...
public fun createTsRestType(block: TsRestType.() -> Unit): TsRestType = TsRestType().apply(block)
...
public fun createTsParenthesizedType(block: TsParenthesizedType.() -> Unit): TsParenthesizedType =
    TsParenthesizedType().apply(block)
...
public fun createTsIndexedAccessType(block: TsIndexedAccessType.() -> Unit): TsIndexedAccessType =
    TsIndexedAccessType().apply(block)
...
public fun createInvalid(block: Invalid.() -> Unit): Invalid = Invalid().apply(block)

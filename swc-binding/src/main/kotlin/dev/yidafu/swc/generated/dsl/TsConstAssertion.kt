// Auto-generated file. Do not edit. Generated at: 2025-11-20T00:09:39.384174
 ...
 */
public fun TsConstAssertion.invalid(block: Invalid.() -> Unit): Invalid = Invalid().apply(block)

/**
 * TsConstAssertion#expression: Expression?
 * extension function for create Expression? -> JSXText
 */
public fun TsConstAssertion.jSXText(block: JSXText.() -> Unit): JSXText = JSXText().apply(block)

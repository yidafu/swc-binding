...
fn test_test_fixtures_exist() {
    ...
    assert!(
        fixtures_dir.join("javascript/simple.js").exists(),
        "JavaScript test fixture should exist"
    );
    assert!(
        fixtures_dir.join("typescript/simple.ts").exists(),
        "TypeScript test fixture should exist"
    );
    assert!(
        fixtures_dir.join("options/parse-options.json").exists(),
...
fn test_javascript_fixture_content() {
    ...
    assert!(
        ...
        "JavaScript fixture should contain expected content"
    );
}
...
fn test_typescript_fixture_content() {
    ...
    assert!(
        ...
        "TypeScript fixture should contain interface"
    );
}
...
fn test_options_fixtures() {
    ...
    assert!(
        serde_json::from_str::<serde_json::Value>(&parse_opts).is_ok(),
    ...
    assert!(
        serde_json::from_str::<serde_json::Value>(&transform_opts).is_ok(),
    ...
    assert!(
        serde_json::from_str::<serde_json::Value>(&minify_opts).is_ok(),
